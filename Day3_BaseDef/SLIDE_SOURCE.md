...
> Verified against `Day3_BaseDef/main.gd`, `endless_mode.gd`, `enemy.gd`, `Main.tscn`,
...
1. Open `main.gd` (Day 1 Walkthrough B reapplied to `Day3_BaseDef`).
