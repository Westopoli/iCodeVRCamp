...
func start_match(p1_char: String, p2_char: String, map_id: String) -> void:
	...
	# --- Pre-given: build the two Player instances and place them at opposite
	# ends of the map. Same scene, but setup() configures each with its own
	# player_num, character, and spawn position. ---
